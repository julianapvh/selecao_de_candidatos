# loço de repetição, para que o programa continue aberto após a pesquisa para que o usuário possa continuar a pesquisa se precisar
while True:
...
# função para buscar candidatos
    ...
    # Lista de entrevista com candidatos
